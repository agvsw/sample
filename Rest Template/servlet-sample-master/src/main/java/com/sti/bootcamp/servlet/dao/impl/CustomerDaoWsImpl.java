...
public class CustomerDaoWsImpl implements CustomerDao {
	...
	public Customer getById(int customerNumber) {
		...
		ResponseEntity<CommonResponse<Customer>> response1 = restTemplate.exchange(
				getCustomerUrl,
				HttpMethod.PUT,
				null,
	...
	public Customer save(Customer customer) {
		...
		ResponseEntity<String> response = restTemplate.postForEntity(create(postCustomerUrl), customer, String.class);
